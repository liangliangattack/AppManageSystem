...
MySQL - 5.7.22 : Database - appinfodb
*********************************************************************
*/
...
insert  into `backend_user`(`id`,`user_code`,`user_name`,`user_type`,`created_by`,`creation_date`,`modify_by`,`modify_date`,`user_password`) values (1,'admin','系统管理员',1,1,'2016-08-20 00:13:41',NULL,NULL,'123456');
...
insert  into `dev_user`(`id`,`dev_code`,`dev_name`,`dev_password`,`dev_email`,`dev_info`,`created_by`,`creation_date`,`modify_by`,`modify_date`) values (1,'test001','测试账户001','123456',NULL,NULL,1,'2016-08-20 00:13:41',NULL,NULL);
